...
public interface BatchOperation {
	...
	default <T> int doOneBatchInsert(TypeHandlerRegistry thr, Connection conn, List<T> poList, Table table, String sql) throws SQLException {
		...
		try {
			for (Object po : poList) {
				preparePoForInsert(thr, ps, po, insertList);
			}
	...
	default void preparePoForInsert(TypeHandlerRegistry thr, PreparedStatement ps, Object po, List<Column> columns) throws SQLException {
