	...
	private void processBeanDefinitions(Set<BeanDefinitionHolder> beanDefinitions) {
		...
		for (BeanDefinitionHolder holder : beanDefinitions) {
			...
			try {
				...
				definition.getPropertyValues().add("baseUri", serviceProxy.baseUri());

				if (StringUtils.isNotBlank(serviceProxy.webClientBeanName())) {
					definition.getPropertyValues().add("webClient", new RuntimeBeanReference(serviceProxy.webClientBeanName()));
				}
