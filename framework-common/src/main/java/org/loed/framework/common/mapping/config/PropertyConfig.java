package org.loed.framework.common.mapping.config;
...
public class PropertyConfig implements Cloneable {
	...
	public boolean equals(Object o) {
		...
		if (destPropertyType != that.destPropertyType) return false;
		if (srcPropertyType != that.srcPropertyType) return false;
