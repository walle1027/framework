...
//	}
	...
	public static String getListTypeParameter(Field field) {
		ParameterizedType pt = (ParameterizedType) field.getGenericType();
	...
	public static String getSetTypeParameter(Field field) {
		return getListTypeParameter(field);
	}

	public static String getArrayTypeParameter(Field field) {
