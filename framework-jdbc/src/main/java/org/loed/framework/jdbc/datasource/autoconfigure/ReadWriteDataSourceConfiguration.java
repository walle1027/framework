...
import org.loed.framework.jdbc.datasource.creator.DataSourceCreator;
import org.loed.framework.jdbc.datasource.creator.druid.DruidDataSourceCreator;
import org.loed.framework.jdbc.datasource.creator.druid.DruidDataSourceDecorator;
import org.loed.framework.jdbc.datasource.meta.DataSourceMetaInfo;
import org.loed.framework.jdbc.datasource.readwriteisolate.ReadWriteIsolateDataSource;
import org.loed.framework.jdbc.datasource.readwriteisolate.provider.ReadWriteDataSourceProvider;
import org.loed.framework.jdbc.datasource.readwriteisolate.provider.support.ConfiguredReadWriteDataSourceProvider;
import org.loed.framework.jdbc.datasource.readwriteisolate.provider.support.ZKReadWriteDataSourceProvider;
...
public class ReadWriteDataSourceConfiguration {
	...
	@Bean
	@ConditionalOnMissingClass(value = "org.loed.framework.jdbc.datasource.autoconfigure.RoutingDataSourceConfigure")
